...
<span class="meta-badge">:material-github: <a href="https://github.com/alirezarezvani/claude-skills/tree/main/ra-qm-team/skills/agent-decision-receipts/SKILL.md">Source</a></span>
</div>
...
> See [references/receipt-fields.md](https://github.com/alirezarezvani/claude-skills/tree/main/ra-qm-team/skills/agent-decision-receipts/references/receipt-fields.md) for the full receipt schema and the post-quantum rationale.
