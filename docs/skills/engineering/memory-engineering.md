...
- [`assets/forgetting_policy_template.md`](https://github.com/alirezarezvani/claude-skills/tree/main/engineering/memory-engineering/skills/memory-engineering/assets/forgetting_policy_template.md) — fillable policy covering F1–F8
