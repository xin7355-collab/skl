...
- [cs-vpe-advisor](../../c-level-agents/agents/cs-vpe-advisor.md) — escalate throughput / org / DORA
- [cs-ciso-advisor](../../c-level-agents/agents/cs-ciso-advisor.md) — escalate regulated-data exposure
